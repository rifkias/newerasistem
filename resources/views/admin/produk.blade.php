...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Produk Website</h4>
                <h6 class="card-subtitle" style="text-align: right"><button onclick="ShowAddModal()" class="btn btn-success"><i class="fa fa-plus"></i>Tambah Produk</button></h6>
                <div class="">
...
<div class="modal fade" id="MyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                <label for="descBanner" class="col-sm-3 col-form-label">Deskripsi Singkat</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="descBanner" class="col-sm-3 col-form-label">Deskripsi Panjang</label>
                <div class="col-sm-9">
                    <textarea required class="form-control @if(@$errors->has(descBanner)) is-invalid @elseif(old('descBanner') !== null) is-valid @endif" id="descBanner" name="descBanner"> {{old('descBanner')}} </textarea>
                    @if($errors->has('descBanner'))
                        <div class="invalid-feedback">
