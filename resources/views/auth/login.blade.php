                        ...
                        <div class="col-12">
                            <form method="POST" class="form-horizontal m-t-20" id="loginform" action="{{ route('login') }}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control form-control-lg @if($errors->has('email')) is-invalid @elseif(old('email') !== null) is-valid @endif" placeholder="Email" aria-label="Email" aria-describedby="basic-addon1" value="{{old('email')}}">
                                    @if ($errors->has('email'))
