						...
						<div class="at-testimonials">
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pull-left">
								<div class="at-testimonial">
									<figure class="at-featureimg"><a href="javascript:void(0);"><img src="{{asset('/template/images/testimonials/img-01.jpg')}}" alt="image description"></a></figure>
									<div class="clearfix"></div>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pull-left">
								<div class="at-testimonial">
									<figure class="at-featureimg"><a href="javascript:void(0);"><img src="{{asset('/template/images/testimonials/img-02.jpg')}}" alt="image description"></a></figure>
									<div class="clearfix"></div>
									<span class="at-stars"><span></span></span>
									<blockquote>
							...
							<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pull-left">
								<div class="at-testimonial">
									<figure class="at-featureimg"><a href="javascript:void(0);"><img src="{{asset('/template/images/testimonials/img-03.jpg')}}" alt="image description"></a></figure>
									<div class="clearfix"></div>
									<span class="at-stars"><span></span></span>
									<blockquote>
										<q>Don't cry because it's over, smile because it happened.</q>
